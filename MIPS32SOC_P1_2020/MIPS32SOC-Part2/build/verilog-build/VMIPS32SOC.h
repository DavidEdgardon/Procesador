...
VL_MODULE(VMIPS32SOC) {
  ...
  public:
    ...
    static void _initial__TOP__1(VMIPS32SOC__Syms* __restrict vlSymsp);
    static void _settle__TOP__2(VMIPS32SOC__Syms* __restrict vlSymsp);
} VL_ATTR_ALIGNED(128);
