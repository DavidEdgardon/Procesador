...
module ControlUnit (
  ...
  assign RegDst = s8[6];
  assign aluSrc = s8[7];
  assign Jump_temp = s8[8];
  assign RegWrite = Jump_temp;
  assign branchNotEqual = Jump_temp;
  assign branchEqual = Jump_temp;
...
module MIPS32SOC (
  ...
  ControlUnit ControlUnit_i1 (
    ...
    .memWrite( memWrite ),
    .RegWrite( RegWrite ),
    .branchNotEqual( brachEqual ),
    .branchEqual( brachNotEqual ),
    .Jump( Jump )
  );
  // PC
  DIG_Register_BUS #(
