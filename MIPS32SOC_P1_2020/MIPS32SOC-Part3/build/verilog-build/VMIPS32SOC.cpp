...
void VMIPS32SOC::_initial__TOP__1(VMIPS32SOC__Syms* __restrict vlSymsp) {
    ...
    VMIPS32SOC* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // INITIAL at /home/david/Escritorio/MIPS32SOC_P1_2020/MIPS32SOC-Part3/build/MIPS32SOC.v:818
    vlTOPp->invalid_opcode = 0U;
}

VL_INLINE_OPT void VMIPS32SOC::_settle__TOP__2(VMIPS32SOC__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VMIPS32SOC::_settle__TOP__2\n"); );
    VMIPS32SOC* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlTOPp->invalid_pc = vlSymsp->TOP__MIPS32SOC.__PVT__pcdecoder_i4__DOT__Invalid_pc_temp;
}

VL_INLINE_OPT void VMIPS32SOC::_settle__TOP__3(VMIPS32SOC__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VMIPS32SOC::_settle__TOP__3\n"); );
    VMIPS32SOC* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlTOPp->invalid_addr = vlSymsp->TOP__MIPS32SOC.__PVT__memdecoder_i17__DOT__Invalid_Addres_temp;
}
