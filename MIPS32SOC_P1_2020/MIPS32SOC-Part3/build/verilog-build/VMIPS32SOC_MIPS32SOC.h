...
VL_MODULE(VMIPS32SOC_MIPS32SOC) {
  public:
    ...
    VL_SIG8(__PVT__ALUControl_i8__DOT__s8,2,0);
    VL_SIG8(__PVT__ALUControl_i8__DOT__s9,0,0);
    VL_SIG8(__PVT__memdecoder_i17__DOT__Invalid_Addres_temp,0,0);
    VL_SIG16(__PVT__s23,12,0);
    ...
    VL_SIG(__PVT__s18,31,0);
    VL_SIG(__PVT__shift_Jump,31,0);
    VL_SIG(__PVT__s20,27,0);
    VL_SIG(PC,31,0);
    ...
    static VL_ST_SIG8(__Vtable2___PVT__ALUControl_i8__DOT__s8[128],2,0);
